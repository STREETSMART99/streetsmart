...
const ForgetPassword = () => {
  ...
  return (
    <div className="forget-password-page w-full min-h-screen flex items-center justify-center bg-gray-100 p-10 relative">
      <Link to="/login" className="top-header">
        <ArrowLeft />
        <span>Go back</span> {/* Updated text */}
      </Link>
        ...
        <div className="flex items-center gap-16 justify-between w-full">
          ...
          <div className="right_wrapper space-y-4 max-w-[640px] w-full h-auto">
            ...
            <form className="space-y-4" onSubmit={handleForget}>
              ...
              <button
                className="max-w-[640px] w-full h-[56px] bg-[#515def] rounded-lg flex items-center justify-center text-base text-[#f3f3f3] capitalize font-semibold cursor-pointer">
                Submit
              </button>
            </form>
          </div>
